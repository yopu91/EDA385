------------------------------------------------------------------------------
-- vga_ip - entity/architecture pair
------------------------------------------------------------------------------
--
-- ***************************************************************************
...
-- In this section, we povide an example implementation of ENTITY vga_ip
...
-- ENTITY vga_ip to implement your coprocessor

architecture EXAMPLE of vga_ip is
