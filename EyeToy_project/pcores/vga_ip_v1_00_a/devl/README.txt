...
File Summary
  ...
  - HDL source -
  C:\temp\pcores\vga_ip_v1_00_a\hdl\vhdl
  top level      : vga_ip.vhd

  - XPS interface -
  C:\temp\pcores\vga_ip_v1_00_a\data
  mpd            : vga_ip_v2_1_0.mpd
  pao            : vga_ip_v2_1_0.pao

  - Misc file -
  C:\temp\pcores\vga_ip_v1_00_a\devl
  help           : README.txt
  option         : ipwiz.opt
  log            : ipwiz.log
...
written into src/vga_ip.c in the Driver Directory.
...
implemented in hdl/vhdl/vga_ip.vhd in the Core Directory.
